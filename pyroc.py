...
def plot_multiple_roc(rocList,title='',labels=None, include_baseline=False, equal_aspect=True,file_name=False):
    ...
    def auc(self,fpnum=0):
        ...
        while current_index < len(relevant_pauc):
            ...
            if relevant_pauc[current_index][0] == 0:
                ...
                tp_count +=1
            fpr = fp_count/(total_n+0.00000000000000000000000000000000000000001)
            tpr = tp_count/(total_p+0.00000000000000000000000000000000000000001)
            previous_df = df
            current_index +=1
